...
QT_MOC_LITERAL(1, 9, 10), // "trans_over"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 4) // "data"

    },
    "mythread\0trans_over\0\0data"
};
...
void mythread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->trans_over((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&mythread::trans_over)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void mythread::trans_over(QString _t1)
{
